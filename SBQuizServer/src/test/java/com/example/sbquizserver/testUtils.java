...
public class testUtils {
    ...
    public static final ArrayList<Question> QUESTIONS = new ArrayList<>(List.of(
            new Question(1, 0, "What year was The Battle of Hastings?", new ArrayList<>(
                    List.of(
            ...
            new Question(2, 0, "How many different wives did Henry VIII have?", new ArrayList<>(
                    List.of(
            ...
            new Question(3, 1, "What values can a bit hold?", new ArrayList<>(
                    List.of(
            ...
            new Question(4, 1, "How many bits make a nibble?", new ArrayList<>(
                    List.of(
            ...
            new Question(5, 1, "How many bits are there in a byte?", new ArrayList<>(
                    List.of(
            ...
            new Question(6, 1, "What is the biggest value a byte can hold?", new ArrayList<>(
                    List.of(
            ...
            new Question(7, 1, "1024 bytes equals what?", new ArrayList<>(
                    List.of(
